...
3. 🔁 Step 3: Find Inverses y1,y2,y3
- We need:
    1. 77^−1mod5
...
# T9: Find the order of elements and primitive roots of a'=x (mod 19) defined for the group G=
<Z19>, x).

- 
1. 🧠 Step 1: Order of the Group

2. 🔢 Step 2: Possible Orders of Elements
Orders must divide 18:
- 1,2,3,6,9,18
	​
3. 🔍 Step 3: Find Primitive Roots
👉 Primitive roots = elements of order 18
Number of primitive roots:
ϕ(18)=6

4. 🔁 Generate All Primitive Roots
If g is primitive root, then:
> g^k, gcd(k,18)=1
- Values of k:
1,5,7,11,13,17
- 🔢 Compute:
